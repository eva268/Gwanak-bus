...
with st.sidebar.form(key="my_form"):
    ...
    pressed = st.form_submit_button("이동")
...
with tab2:
   ...
   image1 = Image.open('./img/seoul1.png')
   image2 = Image.open('./img/seoul2.png')
   image3 = Image.open('./img/seoul3.png')

   image11 = st.image(image1, use_column_width=True)
   st.write("- 사당-신도림에 걸친 서울시 3대 도심 여의도˙영등포와 강남을 잇는 교통의 요지")
   image222 = st.image(image2, use_column_width=True)
...
with tab4:
    ...
    image4 = Image.open('./img/price.png')
...
with tab6:  
    ...
    image6 = Image.open('./img/app.png')
    image66 = st.image(image6, use_column_width=True)
    st.write("- 저상버스 위치 정보 제공 필요성 : 교통약자를 위한 저상버스의 실시간 위치 정보 제공의 필요성")
    image7 = Image.open('./img/lfbus.png')
    image77 = st.image(image7, use_column_width=True)
    image8 = Image.open('./img/news.png')
    ...
    image10 = Image.open('./img/bikes.png')
