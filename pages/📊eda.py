...
with tab1:
    ...
    df = pd.read_csv('./src/2023년_버스노선별_정류장별_시간대별_승하차_인원_정보(02월).csv', encoding='cp949', low_memory=False)
...
with tab5:
    ...
    image13 = Image.open('./img/image13.png')
